...
<center>
<img src="Images/info.gif" ><font face=Times size=7> Outbox</font>
</center>
<hr size=10 color="#336699" style="box-shadow:1px 1px 5px aqua" >
<form action=delmail.jsp?type=out  method=post>
<table border=2 cellspacing=5 cellpadding=5 width="100%" >
<tr><th>Delete</th><th>To</th><Td>Subject</th><th>Date</th><th>Message</th></tr>
<%
java.util.Date d=new java.util.Date();
String uid=(String)session.getValue("uid");
Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
Connection con=DriverManager.getConnection("jdbc:odbc:mmail");
PreparedStatement smt=con.prepareStatement("select * from mails where mailfrom=?");
smt.setString(1,uid);
ResultSet rs=smt.executeQuery();
while(rs.next())
	{
	String mid=rs.getString(1);
	String mfrom=rs.getString("mailto");
